<template lang="html">
  <div class="c-comment">
    <div class="c-comment__content">
      ...
      <button v-if='remove' class="c-comment__submit" type="button" name="button" @click='removeComment'>
...
export default {
  ...
  methods:{
    ...
    removeComment(){
      this.remove = !this.remove;
      comments.deleteById( this.comment.data.id );
      this.$emit('commentRemoved',{commentId:this.comment.data.id, index:this.comment.index, postIndex:this.comment.postIndex});
    }
  }
}
</script>
