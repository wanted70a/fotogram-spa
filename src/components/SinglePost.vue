  ...
  <div class="c-post">
    ...
    <div class="c-post__info">
      <div class="c-post__info__cta">
        ...
        <div class="c-post__info__comments"  @click='showCommentsModal'>
    ...
    <div class="c-post__comments">
      <app-single-comment v-for='( comment, i) in post.data.comments.slice(0,3)' :key='i' :comment='{ data:comment, index:i }'/>
    </div>
  </div>
</template>
...
.b-post-modal{
    .c-post__avatar__name, .c-post__info__stats{
        color: white;
    }
}
</style>
