<template lang="html">
  <header class='b-header'>
      <nav class='b-header__nav'>
          ...
          <router-link v-if='isDesk' :to="{ name: 'user', params: { id: logedUser.id }}" class='b-header__nav__link'>
            <img v-if='logedUser.image.profile' :src='IMG + logedUser.image.profile' alt="">
          </router-link>
      ...
      <div class="b-header__breadcrumbs">
          <h1 class='c-logo'><span>photo</span>gram</h1>
      </div>
      <div class="b-header__util">
          <div class="b-header__util__search b-header__util__item">
